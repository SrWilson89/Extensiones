  ...
  function loadNotes() {
    chrome.storage.local.get('notes', (data) => {
      ...
      notes.forEach((note, index) => {
        ...
        // CORRECCIÓN: Aplicar el color de fondo a todo el li
        li.style.backgroundColor = note.bgColor || '#fff9c4'; 
        
        const noteText = document.createElement('p');
        noteText.textContent = note.text;
        noteText.style.color = note.textColor || '#000000';
        // noteText.style.backgroundColor = note.bgColor || '#fff9c4'; // <-- ELIMINADO/NO NECESARIO AQUÍ
